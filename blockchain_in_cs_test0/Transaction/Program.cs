    ...
    class Program
    {
        static void Main()
        {
            ...
            foreach (TxIn input in inputs)
            {
                ...
                // idx of out from prev tx, that has been spent in the current tx
                Console.WriteLine();
            }

            // Let's create a txout with 21 bitcoin from the first ScriptPubKey
            ...
            Console.WriteLine(spentAmount.ToDecimal(MoneyUnit.BTC)-
                receivedAmount.ToDecimal(MoneyUnit.BTC));
